...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Field Tag',
                'verbose_name_plural': 'Field Tags',
            },
        ),
        migrations.CreateModel(
            name='ModelTag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_id', models.IntegerField(db_index=True, verbose_name='object ID')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_tagged_items', to='contenttypes.contenttype', verbose_name='content type')),
                ('field_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_items', to='tag_fields.fieldtag')),
            ],
            options={
                'verbose_name': 'Field Tag IntFk',
                'verbose_name_plural': 'Field Tags IntFk',
