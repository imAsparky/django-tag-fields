# Generated by Django 4.2 on 2023-05-09 02:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tags', tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tag_fields.ModelTagIntFk', to='tag_fields.ModelTag', verbose_name='Model Tags')),
            ],
        ),
        migrations.CreateModel(
            name='Pet',
        ...
        migrations.AddField(
            model_name='uuidpet',
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.UUIDTaggedItem', to='tests.UUIDTag', verbose_name='Model Tags'),
        ),
        migrations.CreateModel(
            name='UUIDFood',
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('tags', tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.UUIDTaggedItem', to='tests.UUIDTag', verbose_name='Model Tags')),
            ],
            options={
                'ordering': ['created_at'],
            },
        ...
        migrations.AddField(
            ...
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.OfficialThroughModel', to='tests.OfficialTag', verbose_name='Model Tags'),
        ),
        migrations.CreateModel(
            name='OfficialFood',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('tags', tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.OfficialThroughModel', to='tests.OfficialTag', verbose_name='Model Tags')),
            ],
        ),
        migrations.CreateModel(
            name='Name',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tags1', tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tag_fields.ModelTagIntFk', to='tag_fields.ModelTag', verbose_name='Model Tags')),
                ('tags2', tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.ThroughGFK', to='tag_fields.ModelTag', verbose_name='Model Tags')),
            ],
        ),
        migrations.AddField(
            model_name='multipletags',
            name='tags1',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.Through1', to='tag_fields.ModelTag', verbose_name='Model Tags'),
        ),
        migrations.AddField(
            model_name='multipletags',
            name='tags2',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.Through2', to='tag_fields.ModelTag', verbose_name='Model Tags'),
        ),
        migrations.CreateModel(
            name='Movie',
            fields=[
        ...
        migrations.AddField(
            ...
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.TaggedTrackedPet', to='tests.TrackedTag', verbose_name='Model Tags'),
        ),
        migrations.AddField(
            model_name='directtrackedfood',
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.TaggedTrackedFood', to='tests.TrackedTag', verbose_name='Model Tags'),
        ),
        migrations.AddField(
            model_name='directpet',
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.TaggedPet', to='tag_fields.ModelTag', verbose_name='Model Tags'),
        ),
        migrations.AddField(
            model_name='directfood',
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.TaggedFood', to='tag_fields.ModelTag', verbose_name='Model Tags'),
        ),
        migrations.AddField(
            model_name='directcustompkpet',
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.TaggedCustomPKPet', to='tag_fields.ModelTag', verbose_name='Model Tags'),
        ),
        migrations.AddField(
            model_name='directcustompkfood',
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.TaggedCustomPKFood', to='tag_fields.ModelTag', verbose_name='Model Tags'),
        ),
        migrations.AddField(
            model_name='custompkpet',
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.TaggedCustomPK', to='tag_fields.ModelTag', verbose_name='Model Tags'),
        ),
        migrations.CreateModel(
            name='CustomPKFood',
            fields=[
                ('name', models.CharField(max_length=50, primary_key=True, serialize=False)),
                ('tags', tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.TaggedCustomPK', to='tag_fields.ModelTag', verbose_name='Model Tags')),
            ],
        ),
        migrations.CreateModel(
            name='CustomManager',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('tags', tag_fields.managers.ModelTagsManager(blank=True, help_text='A comma-separated list of a models tags.', through='tag_fields.ModelTagIntFk', to='tag_fields.ModelTag', verbose_name='Model Tags')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
                ...
                ('tags', tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.ArticleTaggedItem', to='tag_fields.ModelTag', verbose_name='Model Tags')),
            ],
        ),
        migrations.CreateModel(
            name='ProxyPhoto',
        ...
        migrations.AddField(
            ...
            name='tags',
            field=tag_fields.managers.ModelTagsManager(help_text='A comma-separated list of a models tags.', through='tests.MultiInheritanceLazyResolutionFoodTag', to='tag_fields.ModelTag', verbose_name='Model Tags'),
        ),
    ]
